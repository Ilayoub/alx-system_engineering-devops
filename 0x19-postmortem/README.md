...
*Timeline
00:02 PST - 404 error for anyone trying to access the website
00:15 PST - Ensuring Apache and MySQL are up and running.
00:18 PST - The website was not loading properly which on background check revealed that the server was working properly as well as the database.
00:21 PST - After quick restart to Apache server returned a status of 200 and OK while trying to curl the website.
00:23 PST - Reviewing error logs to check where the error might be coming from.
